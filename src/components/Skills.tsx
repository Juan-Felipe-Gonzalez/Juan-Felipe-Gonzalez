  ...
  return (
    <main className="w-[95%] max-w-[1200px] mx-auto lg:w-full" id='stack'>
      <div className='flex flex-wrap m-auto justify-center'>
          <button 
            className={`inline-block border cursor-pointer shadow-lg shadow-[#151530]/50 p-6 m-1 rounded-xl text-white ${skillSelected == translation.titlesSkills.frontend ? 'border-[#21215b] bg-[#151530]' : 'border-[#20202e] bg-[#111118]'}`}
          ...
          <button 
            className={`inline-block border cursor-pointer shadow-lg shadow-[#151530]/50 p-6 m-1 rounded-xl text-white ${skillSelected == translation.titlesSkills.backend ? 'border-[#21215b] bg-[#151530]' : 'border-[#20202e] bg-[#111118]'}`}
          ...
          <button 
            className={`inline-block border cursor-pointer shadow-lg shadow-[#151530]/50 p-6 m-1 rounded-xl text-white ${skillSelected == translation.titlesSkills.cloud ? 'border-[#21215b] bg-[#151530]' : 'border-[#20202e] bg-[#111118]'}`}
          ...
          <button 
            className={`inline-block border cursor-pointer shadow-lg shadow-[#151530]/50 p-6 m-1 rounded-xl text-white ${skillSelected == translation.titlesSkills.design ? 'border-[#21215b] bg-[#151530]' : 'border-[#20202e] bg-[#111118]'}`}
          ...
          <button 
            className={`inline-block border cursor-pointer shadow-lg shadow-[#151530]/50 p-6 m-1 rounded-xl text-white ${skillSelected == translation.titlesSkills.languages ? 'border-[#21215b] bg-[#151530]' : 'border-[#20202e] bg-[#111118]'}`}
