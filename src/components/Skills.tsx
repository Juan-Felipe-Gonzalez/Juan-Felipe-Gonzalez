  ...
  return (
    <main className="w-[95%] max-w-[1200px] mx-auto lg:w-full" id='stack'>
      ...
      <div className='flex flex-wrap m-auto justify-center'>
        <button
          className={`border cursor-pointer shadow-lg shadow-[#151530]/50 p-6 m-1 rounded-xl text-white  ${skillSelected == translation.titlesSkills.frontend.id ? 'border-[#21215b] bg-[#151530] flex-1' : 'border-[#20202e] bg-[#111118] flex'}`}
        ...
        <button
          className={`border cursor-pointer shadow-lg shadow-[#151530]/50 p-6 m-1 rounded-xl text-white ${skillSelected == translation.titlesSkills.backend.id ? 'border-[#21215b] bg-[#151530] flex-1' : 'border-[#20202e] bg-[#111118] flex'}`}
        ...
        <button
          className={`border cursor-pointer shadow-lg shadow-[#151530]/50 p-6 m-1 rounded-xl text-white ${skillSelected == translation.titlesSkills.cloud.id ? 'border-[#21215b] bg-[#151530] flex-1' : 'border-[#20202e] bg-[#111118] flex'}`}
        ...
        <button
          className={`border cursor-pointer shadow-lg shadow-[#151530]/50 p-6 m-1 rounded-xl text-white ${skillSelected == translation.titlesSkills.design.id ? 'border-[#21215b] bg-[#151530] flex-1' : 'border-[#20202e] bg-[#111118] flex'}`}
        ...
        <button
          className={`border cursor-pointer shadow-lg shadow-[#151530]/50 p-6 m-1 rounded-xl text-white ${skillSelected == translation.titlesSkills.languages.id ? 'border-[#21215b] bg-[#151530] flex-1' : 'border-[#20202e] bg-[#111118] flex'}`}
